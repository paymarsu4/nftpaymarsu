...
export default function CreateNFT() {
  ...
  const { data: paymentcategories, error } = useSWR('/api/paymentcategories/getforopt', () =>
    axios.get('/api/paymentcategories/getforopt')
        .then(res => res.data)
        .catch(error => {
            // console.log(error)
  ...
  async function getPC(pcId) {
    if (pcId!=""){
      const category = await axios.get('/api/paymentcategories/show/'+pcId)
          .then(res => res.data)
          .catch(error => {
              // console.log(error)
              if (error.response.status !== 409) throw error
        ...
        <div className="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                {isConnected ? (
                  ...
                  <div className="mt-4">
                    <Label htmlFor="price">Price (in POL)<span className="text-red-500">*</span></Label>
                    <Input
                        id="price"
                        type="number"
                    ...
                    <small>Below are the available links for converting PHP to POL:</small>
                    <ul className="text-blue-700">
                      <li>
                      <a href="https://www.coinbase.com/converter/matic/php" target="_blank" rel="noreferrer">Coinbase converter</a>
                      </li>
                      <li>
                      <a href="https://www.bitget.com/price/polygon/php" target="_blank" rel="noreferrer">BitGet converter</a>
                      </li>
                      <li>
                      <a href="https://www.coingecko.com/en/coins/polygon/php" target="_blank" rel="noreferrer">CoinGecko converter</a>
                      </li>
                    </ul>
